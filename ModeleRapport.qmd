...
respca$eig
```
Dans cette étude, nous retenons les trois premières dimensions, dont l’inertie cumulée atteint 85,88 % ( @fig-12 ). Ce choix permet de conserver l’essentiel de l’information initiale tout en réduisant significativement la dimension des données (de 7 à 3), ce qui facilite leur visualisation et leur interprétation
